...
const EditBatchSchedule = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!batchId) {
      alert("Please enter the Batch Schedule ID to edit.");
      return;
    }

    try {
      const response = await fetch(
        `http://localhost:3030/trainer/editBatchSchedule/${batchId}`,
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.heading}>Edit Batch Schedule</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div style={styles.formRow}>
          ...
          <div style={styles.fieldWrapper} ref={dropdownRef}>
